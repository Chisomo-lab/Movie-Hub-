...
async function fetchVideos(category){
  ...
  // Sports: football first + descending year
  if(category === 'sports'){
...
// Render videos in a category grid
...
// Smooth auto-scroll trending horizontal strip
function autoScrollTrending() {
  ...
  trendingSections.forEach(section => {
    ...
    function step(){
      ...
      if(section.scrollLeft >= section.scrollWidth - section.clientWidth) section.scrollLeft = 0;
...
// Observe changes to categories container
