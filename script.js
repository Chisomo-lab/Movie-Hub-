...
// Show category page with trending strip and infinite scroll
async function showCategory(cat){
  ...
  // Trending horizontal top (first 4 videos)
...
// Infinite scroll for categories only
